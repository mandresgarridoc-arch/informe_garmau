...
function Prompts() {
  return (
    <div className="bg-slate-900/60 backdrop-blur-sm border border-slate-800 rounded-xl shadow-[0_0_15px_rgba(0,0,0,0.5)] p-5 md:p-8">
      <div className="flex items-center gap-3 mb-6 md:mb-8 border-b border-fuchsia-500/20 pb-4">
        <Bot className="text-fuchsia-400 drop-shadow-[0_0_8px_rgba(232,121,249,0.6)]" size={28} />
        <h2 className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-purple-500">
          Bitácora de Uso de IA en el Desarrollo
        </h2>
      </div>

      <div className="space-y-6 md:space-y-8 text-slate-300 text-left md:text-justify">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-950/80 border border-slate-800 rounded-lg overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
            {/* AQUÍ ESTÁ LA MAGIA RESPONSIVA (flex-col en móvil, flex-row en PC) */}
            <div className="bg-slate-900 border-b border-slate-800 px-5 py-3 flex flex-col md:flex-row justify-between md:items-center gap-3 md:gap-0">
              <h3 className="font-bold text-fuchsia-400 leading-tight">Interacción 1: Investigación Legal y Normativa</h3>
              <span className="text-xs font-mono bg-fuchsia-950/50 border border-fuchsia-900 px-2 py-1 rounded text-fuchsia-300 self-start md:self-auto shrink-0">Resumen y Marco Jurídico</span>
            </div>
            <div className="p-4 md:p-5 space-y-4">
              <div>
                <strong className="text-sm text-slate-400 block mb-2 uppercase tracking-wider">Prompts Utilizados:</strong>
                <ul className="list-disc pl-5 space-y-3 text-fuchsia-200/80 text-xs md:text-sm bg-black/50 p-4 rounded border border-slate-800 font-mono shadow-inner overflow-x-auto">
          ...
          <div className="bg-slate-950/80 border border-slate-800 rounded-lg overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
            <div className="bg-slate-900 border-b border-slate-800 px-5 py-3 flex flex-col md:flex-row justify-between md:items-center gap-3 md:gap-0">
              <h3 className="font-bold text-fuchsia-400 leading-tight">Interacción 2: Depuración de React y Tailwind CSS</h3>
              <span className="text-xs font-mono bg-fuchsia-950/50 border border-fuchsia-900 px-2 py-1 rounded text-fuchsia-300 self-start md:self-auto shrink-0">Troubleshooting Web</span>
            </div>
            <div className="p-4 md:p-5 space-y-4">
              <div>
                <strong className="text-sm text-slate-400 block mb-2 uppercase tracking-wider">Prompts Utilizados:</strong>
          ...
          <div className="bg-slate-950/80 border border-slate-800 rounded-lg overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
            <div className="bg-slate-900 border-b border-slate-800 px-5 py-3 flex flex-col md:flex-row justify-between md:items-center gap-3 md:gap-0">
              <h3 className="font-bold text-fuchsia-400 leading-tight">Interacción 3: Control de Versiones y Despliegue</h3>
              <span className="text-xs font-mono bg-fuchsia-950/50 border border-fuchsia-900 px-2 py-1 rounded text-fuchsia-300 self-start md:self-auto shrink-0">Git, GitHub & Vercel</span>
            </div>
            <div className="p-4 md:p-5 space-y-4">
              <div>
                <strong className="text-sm text-slate-400 block mb-2 uppercase tracking-wider">Prompts Utilizados:</strong>
          ...
          <div className="bg-slate-950/80 border border-slate-800 rounded-lg overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
            <div className="bg-slate-900 border-b border-slate-800 px-5 py-3 flex flex-col md:flex-row justify-between md:items-center gap-3 md:gap-0">
              <h3 className="font-bold text-fuchsia-400 leading-tight">Interacción 4: Refinamiento UX/UI y QA</h3>
              <span className="text-xs font-mono bg-fuchsia-950/50 border border-fuchsia-900 px-2 py-1 rounded text-fuchsia-300 self-start md:self-auto shrink-0">Calidad y Metadatos</span>
            </div>
            <div className="p-4 md:p-5 space-y-4">
              <div>
                <strong className="text-sm text-slate-400 block mb-2 uppercase tracking-wider">Prompts Utilizados:</strong>
        ...
        <section className="mt-8 border-t border-slate-800 pt-6">
          ...
          <p className="text-sm md:text-base text-slate-400 leading-relaxed bg-slate-950/50 p-5 md:p-6 rounded-lg border border-slate-800 shadow-inner text-left md:text-justify">
